...
https://docs.djangoproject.com/fr/3.2/ref/settings/
"""
...
# See https://docs.djangoproject.com/fr/3.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-ird+=q2&wzf-++kt&z+^ee@l#fa4@l%yhf0&&6*$&p)es8!t1q'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dkandroid', # le nom de notre base de donnees creee precedemment
